  ...
  while(_i LESS _length)
    ...
    if(NOT _library_dirs)
      ...
      if(NOT _lib)
        # warn about not existing library and later ignore it
        message(WARNING
          "Package 'depthimage_to_laserscan' exports library '${_library_name}' with LIBRARY_DIRS '${_library_dirs}' which couldn't be found")
      endif()
    endif()
    if(_lib)
      list(APPEND depthimage_to_laserscan_LIBRARIES ${_cfg} "${_lib}")
...
# TODO(dirk-thomas) deduplicate depthimage_to_laserscan_LIBRARIES
