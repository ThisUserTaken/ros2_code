...
static const _ImuWithMagneticField_type_support_symbol_names_t _ImuWithMagneticField_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, depthai_ros_msgs, msg, ImuWithMagneticField)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, depthai_ros_msgs, msg, ImuWithMagneticField)),
  }
};
...
{
  return &::depthai_ros_msgs::msg::rosidl_typesupport_cpp::ImuWithMagneticField_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, depthai_ros_msgs, msg, ImuWithMagneticField)() {
  return get_message_type_support_handle<depthai_ros_msgs::msg::ImuWithMagneticField>();
}
