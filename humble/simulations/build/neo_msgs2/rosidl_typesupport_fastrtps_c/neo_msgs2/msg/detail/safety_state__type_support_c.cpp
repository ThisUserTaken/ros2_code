...
#include "neo_msgs2/msg/detail/safety_state__rosidl_typesupport_fastrtps_c.h"
...
using _SafetyState__ros_msg_type = neo_msgs2__msg__SafetyState;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    size_t size = 7;
    auto array_ptr = ros_message->triggered_cutoff_paths;
...
size_t get_serialized_size_neo_msgs2__msg__SafetyState(
  const void * untyped_ros_message,
...
static uint32_t _SafetyState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_neo_msgs2__msg__SafetyState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_neo_msgs2
size_t max_serialized_size_neo_msgs2__msg__SafetyState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = neo_msgs2__msg__SafetyState;
    is_plain =
      (
...
static size_t _SafetyState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_neo_msgs2__msg__SafetyState(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, neo_msgs2, msg, SafetyState)() {
