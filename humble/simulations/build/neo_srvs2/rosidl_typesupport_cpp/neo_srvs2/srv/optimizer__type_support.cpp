...
static const _Optimizer_Request_type_support_symbol_names_t _Optimizer_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, neo_srvs2, srv, Optimizer_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, neo_srvs2, srv, Optimizer_Request)),
  }
};
...
{
  return &::neo_srvs2::srv::rosidl_typesupport_cpp::Optimizer_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, neo_srvs2, srv, Optimizer_Request)() {
  return get_message_type_support_handle<neo_srvs2::srv::Optimizer_Request>();
}
...
static const _Optimizer_Response_type_support_symbol_names_t _Optimizer_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, neo_srvs2, srv, Optimizer_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, neo_srvs2, srv, Optimizer_Response)),
  }
};
...
{
  return &::neo_srvs2::srv::rosidl_typesupport_cpp::Optimizer_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, neo_srvs2, srv, Optimizer_Response)() {
  return get_message_type_support_handle<neo_srvs2::srv::Optimizer_Response>();
}
...
static const _Optimizer_type_support_symbol_names_t _Optimizer_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, neo_srvs2, srv, Optimizer)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, neo_srvs2, srv, Optimizer)),
  }
};
...
{
  return &::neo_srvs2::srv::rosidl_typesupport_cpp::Optimizer_service_type_support_handle;
}
