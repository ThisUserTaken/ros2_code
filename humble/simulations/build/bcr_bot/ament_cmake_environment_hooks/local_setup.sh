...
: ${AMENT_CURRENT_PREFIX:="/root/ros2_code/humble/simulations/install/bcr_bot"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/bcr_bot/environment/bcr_bot.sh"
