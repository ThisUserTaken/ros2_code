...
bool ros_gz_interfaces__msg__gui_camera__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros_gz_interfaces.msg._gui_camera.GuiCamera", full_classname_dest, 43) == 0);
  }
  ros_gz_interfaces__msg__GuiCamera * ros_message = _ros_message;
  {  // header
  ...
  {  // track
    ...
    if (!ros_gz_interfaces__msg__track_visual__convert_from_py(field, &ros_message->track)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * ros_gz_interfaces__msg__gui_camera__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros_gz_interfaces.msg._gui_camera");
  ...
  {  // track
    PyObject * field = NULL;
    field = ros_gz_interfaces__msg__track_visual__convert_to_py(&ros_message->track);
    if (!field) {
      return NULL;
    }
    {
