...
bool ros_gz_interfaces__msg__contact__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros_gz_interfaces.msg._contact.Contact", full_classname_dest, 38) == 0);
  }
  ros_gz_interfaces__msg__Contact * ros_message = _ros_message;
  {  // collision1
...
PyObject * ros_gz_interfaces__msg__contact__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros_gz_interfaces.msg._contact");
