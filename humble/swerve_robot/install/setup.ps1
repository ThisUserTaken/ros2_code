...
_colcon_prefix_chain_powershell_source_script "/root/ros2_code/humble/Asimcar/install\local_setup.ps1"
_colcon_prefix_chain_powershell_source_script "/root/ros2_code/humble/four_ws_ros2/install\local_setup.ps1"
