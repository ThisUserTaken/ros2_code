...
#include "neo_msgs2/msg/detail/us_board_v2__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  {
    size_t array_size = 16;
    size_t item_size = sizeof(ros_message.active[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = neo_msgs2::msg::USBoardV2;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const neo_msgs2::msg::USBoardV2 *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<neo_msgs2::msg::USBoardV2 *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _USBoardV2__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const neo_msgs2::msg::USBoardV2 *>(
...
static size_t _USBoardV2__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_USBoardV2(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _USBoardV2__callbacks = {
  "neo_msgs2::msg",
  "USBoardV2",
...
static rosidl_message_type_support_t _USBoardV2__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_USBoardV2__callbacks,
...
{
  return &neo_msgs2::msg::typesupport_fastrtps_cpp::_USBoardV2__handle;
}
