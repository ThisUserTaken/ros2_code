...
#include "neo_msgs2/msg/detail/emergency_stop_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const neo_msgs2::msg::EmergencyStopState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  neo_msgs2::msg::EmergencyStopState & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_neo_msgs2
max_serialized_size_EmergencyStopState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = neo_msgs2::msg::EmergencyStopState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const neo_msgs2::msg::EmergencyStopState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<neo_msgs2::msg::EmergencyStopState *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _EmergencyStopState__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const neo_msgs2::msg::EmergencyStopState *>(
...
static size_t _EmergencyStopState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_EmergencyStopState(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _EmergencyStopState__callbacks = {
  "neo_msgs2::msg",
  "EmergencyStopState",
...
static rosidl_message_type_support_t _EmergencyStopState__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_EmergencyStopState__callbacks,
...
{
  return &neo_msgs2::msg::typesupport_fastrtps_cpp::_EmergencyStopState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, neo_msgs2, msg, EmergencyStopState)() {
  return &neo_msgs2::msg::typesupport_fastrtps_cpp::_EmergencyStopState__handle;
}
