...
static const _IOBoardSetDigOut_Request_type_support_symbol_names_t _IOBoardSetDigOut_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, neo_srvs2, srv, IOBoardSetDigOut_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, neo_srvs2, srv, IOBoardSetDigOut_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, neo_srvs2, srv, IOBoardSetDigOut_Request)() {
  return &::neo_srvs2::srv::rosidl_typesupport_c::IOBoardSetDigOut_Request_message_type_support_handle;
}
...
static const _IOBoardSetDigOut_Response_type_support_symbol_names_t _IOBoardSetDigOut_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, neo_srvs2, srv, IOBoardSetDigOut_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, neo_srvs2, srv, IOBoardSetDigOut_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, neo_srvs2, srv, IOBoardSetDigOut_Response)() {
  return &::neo_srvs2::srv::rosidl_typesupport_c::IOBoardSetDigOut_Response_message_type_support_handle;
}
...
static const _IOBoardSetDigOut_type_support_symbol_names_t _IOBoardSetDigOut_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, neo_srvs2, srv, IOBoardSetDigOut)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, neo_srvs2, srv, IOBoardSetDigOut)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, neo_srvs2, srv, IOBoardSetDigOut)() {
  return &::neo_srvs2::srv::rosidl_typesupport_c::IOBoardSetDigOut_service_type_support_handle;
}
