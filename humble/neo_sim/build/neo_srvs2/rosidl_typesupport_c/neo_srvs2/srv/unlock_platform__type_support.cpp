...
static const _UnlockPlatform_Request_type_support_symbol_names_t _UnlockPlatform_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, neo_srvs2, srv, UnlockPlatform_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, neo_srvs2, srv, UnlockPlatform_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, neo_srvs2, srv, UnlockPlatform_Request)() {
  return &::neo_srvs2::srv::rosidl_typesupport_c::UnlockPlatform_Request_message_type_support_handle;
}
...
static const _UnlockPlatform_Response_type_support_symbol_names_t _UnlockPlatform_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, neo_srvs2, srv, UnlockPlatform_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, neo_srvs2, srv, UnlockPlatform_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, neo_srvs2, srv, UnlockPlatform_Response)() {
  return &::neo_srvs2::srv::rosidl_typesupport_c::UnlockPlatform_Response_message_type_support_handle;
}
...
static const _UnlockPlatform_type_support_symbol_names_t _UnlockPlatform_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, neo_srvs2, srv, UnlockPlatform)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, neo_srvs2, srv, UnlockPlatform)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, neo_srvs2, srv, UnlockPlatform)() {
  return &::neo_srvs2::srv::rosidl_typesupport_c::UnlockPlatform_service_type_support_handle;
}
