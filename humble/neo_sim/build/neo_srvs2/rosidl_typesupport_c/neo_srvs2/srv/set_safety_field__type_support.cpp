...
static const _SetSafetyField_Request_type_support_symbol_names_t _SetSafetyField_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, neo_srvs2, srv, SetSafetyField_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, neo_srvs2, srv, SetSafetyField_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, neo_srvs2, srv, SetSafetyField_Request)() {
  return &::neo_srvs2::srv::rosidl_typesupport_c::SetSafetyField_Request_message_type_support_handle;
}
...
static const _SetSafetyField_Response_type_support_symbol_names_t _SetSafetyField_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, neo_srvs2, srv, SetSafetyField_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, neo_srvs2, srv, SetSafetyField_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, neo_srvs2, srv, SetSafetyField_Response)() {
  return &::neo_srvs2::srv::rosidl_typesupport_c::SetSafetyField_Response_message_type_support_handle;
}
...
static const _SetSafetyField_type_support_symbol_names_t _SetSafetyField_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, neo_srvs2, srv, SetSafetyField)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, neo_srvs2, srv, SetSafetyField)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, neo_srvs2, srv, SetSafetyField)() {
  return &::neo_srvs2::srv::rosidl_typesupport_c::SetSafetyField_service_type_support_handle;
}
