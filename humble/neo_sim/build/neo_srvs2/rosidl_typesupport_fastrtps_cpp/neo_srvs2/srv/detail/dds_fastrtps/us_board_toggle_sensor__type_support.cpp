...
#include "neo_srvs2/srv/detail/us_board_toggle_sensor__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = neo_srvs2::srv::USBoardToggleSensor_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const neo_srvs2::srv::USBoardToggleSensor_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<neo_srvs2::srv::USBoardToggleSensor_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _USBoardToggleSensor_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const neo_srvs2::srv::USBoardToggleSensor_Request *>(
...
static size_t _USBoardToggleSensor_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_USBoardToggleSensor_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _USBoardToggleSensor_Request__callbacks = {
  "neo_srvs2::srv",
...
static rosidl_message_type_support_t _USBoardToggleSensor_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_USBoardToggleSensor_Request__callbacks,
...
{
  return &neo_srvs2::srv::typesupport_fastrtps_cpp::_USBoardToggleSensor_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = neo_srvs2::srv::USBoardToggleSensor_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const neo_srvs2::srv::USBoardToggleSensor_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<neo_srvs2::srv::USBoardToggleSensor_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _USBoardToggleSensor_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const neo_srvs2::srv::USBoardToggleSensor_Response *>(
...
static size_t _USBoardToggleSensor_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_USBoardToggleSensor_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _USBoardToggleSensor_Response__callbacks = {
  "neo_srvs2::srv",
...
static rosidl_message_type_support_t _USBoardToggleSensor_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_USBoardToggleSensor_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &neo_srvs2::srv::typesupport_fastrtps_cpp::_USBoardToggleSensor_Response__handle;
}
...
static service_type_support_callbacks_t _USBoardToggleSensor__callbacks = {
  "neo_srvs2::srv",
  "USBoardToggleSensor",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, neo_srvs2, srv, USBoardToggleSensor_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, neo_srvs2, srv, USBoardToggleSensor_Response)(),
...
static rosidl_service_type_support_t _USBoardToggleSensor__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_USBoardToggleSensor__callbacks,
...
{
  return &neo_srvs2::srv::typesupport_fastrtps_cpp::_USBoardToggleSensor__handle;
}
